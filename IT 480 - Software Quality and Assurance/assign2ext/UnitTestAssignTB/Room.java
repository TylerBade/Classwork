public class Room
{
    ...
    return nouns[(_rand++ % nouns.length)];
    }
    
    private String genDesc() {
        String toReturn = "\nYou see a " + getAdj() + " room.\n" + "It has a " + getAdj() + " " + getNoun() + ".\n";
        
        if (_northExit) {
            toReturn = toReturn + "A " + getAdj() + " door leads North.\n";
        }
        if (_southExit) {
            toReturn = toReturn + "A " + getAdj() + " door leads South.\n";
        }
