# For lab on 9/22, taken straight from
# http://interactivepython.org/runestone/static/pythonds/BasicDS/SimulationPrintingTasks.html
# modifications made to work with normal python modules
# used python's built in queue instead of custom one in original program
