...
class _BNode(object):
	...
	def lateral(self, parent, parent_index, dest, dest_index):
		if parent_index > dest_index: #if parent index is greater than destination index
...
def main():
    # replace this comment with an explanation of the next line
    bt = BTree(5)
    values = ["X","Y","S","C","N","G","K","Q","T","Z","D","M","F","W","L","P","R","A","H","E"]
    i = 0
    while i < len(values):
        bt.insert(values[i])
        i=i+1
